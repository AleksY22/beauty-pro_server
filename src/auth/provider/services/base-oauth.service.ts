...
import type { TypeBaseProviderOptions } from './types/base-provider.options';
...
export class BaseOAuthService {
   ...
   //=======метод извлечения информации о пользователе из ответа================
   ...
   //===========метод генерации url авторизации====================
   public getAuthUrl() {
   ...
   //===========метод обмена кода авторизации на токены================
   ...
   public getRedirectUrl() {
      ...
      // return 'http://localhost:4000/auth/oauth/callback/google';
   }
